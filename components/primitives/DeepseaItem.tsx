...
export default function FishItem({
  ...
  return (
    ...
    >
      <img
        src={getImageUrl("deepsea", f.icon)}
        onError={() => {
      ...
      <div css={styles.row}>
        ...
        <div>{f.shadowSize || "???"} Shadow</div>
      </div>
      <div css={styles.row}>
        <div>
          <FaSwimmer style={styles.icon} />
        </div>
        <div>{f.shadowMovement || "???"}</div>
      </div>
      <div css={styles.row}>
        <div>
          <GiFishingHook style={styles.icon} />
        </div>
        <div>{f.totalCatches || 0}</div>
      </div>
      <div css={styles.row}>
        <div>
